import { STRINGS, CHIPS } from '/strings.js';
...
function screenWriting() {
  ...
  return el('div', { class: 'screen' },
    head(t('writingTitle')),
    room.theme && el('div', { class: 'theme-pill' }, t('themeTonight', room.theme[lang()] || room.theme.da)),
    timerBlock(),
    ...
    el('div', { class: 'card stack' },
      ...
      el('div', { class: 'q-row' },
        el('textarea', { id: 'q-input', maxlength: 240,
          ...
          disabled: atLimit, oninput: (e) => { draftText = e.target.value; } }, draftText),
        hasDraft && el('button', { class: 'q-clear', 'aria-label': t('clear'), onclick: clearDraft }, '✕'),
      ),
      ...
      el('button', { class: 'btn-primary', disabled: atLimit || !hasDraft, onclick: addQuestion }, t('addQuestion')),
...
function screenResult() {
  ...
  return el('div', { class: 'screen' },
    ...
    el('div', { class: 'spacer' }),
    iAmPicked || room.forceContinue
      ? el('div', { class: 'btn-row' },
          el('button', { class: 'btn-danger', disabled: !iAmPicked || r.skipped,
...
function screenOver() {
  ...
  return el('div', { class: 'screen' },
    ...
    el('div', { class: 'spacer' }),
    el('button', { class: 'btn-primary btn-big', onclick: () => { LS.creds = null; location.href = '/'; } }, t('playAgain')),
  );
}
